...
class ElementEspace
{
    public:
        ...
        virtual void reagirCollision(TypeElement typeAutre) = 0;//methode virtuelle pure (utilisee lorsque le methode est uniquement definie dans chaque classe fille) ie: déclaree, mais pas definie.
